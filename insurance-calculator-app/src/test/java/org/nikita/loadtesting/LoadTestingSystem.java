...
class LoadTestingSystem {
    ...
    public void executeForAMinute(int parallelThreadCount, int requestCount) {
        ...
        System.out.println("V1 average = " + statisticV1.getAverageExecutionTime());
        System.out.println("V1 min = " + statisticV1.getMinExecutionTime());
        System.out.println("V1 max = " + statisticV1.getMaxExecutionTime());
    }
