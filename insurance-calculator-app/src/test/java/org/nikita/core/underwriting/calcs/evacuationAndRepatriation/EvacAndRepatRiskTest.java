...
class EvacAndRepatRiskTest {

    @Mock
    private AgeCalcCoefficientEvacuationAndRepatriation ageCalcCoefficient;

    @Mock
    private CountryCalcCoefficientEvacuationAndRepatriation countryCalcCoefficient;

    @Mock
    private InsuranceLimitCalcCoefficientEvacuationAndRepatriation insuranceLimitCalcCoefficient;

    @Mock
    private AgeCalculator ageCalculator;

    @Mock
    private DayCountCalculatorEvacuationAndRepatriation dayCountCalculator;

    @Mock
    private CountryDefaultDayRateEvacuationAndRepatriation countryDefaultDayRateCalculator;

    @InjectMocks
    private TravelEvacuationAndRepatriationRiskPremiumCalculator calculator;
    ...
    void setup() {
        ...
        PersonDto person = new PersonDto("John", "Doe", LocalDate.of(1995, 1, 1));
    ...
    @Test
    void testEvacuationAndRepatriationRiskPremiumCalculator() {
        ...
        // premium = baseCost * 1.1 * ageCoeff * countryCoeff * insuranceCoeff
        BigDecimal baseCost = BigDecimal.valueOf(2).multiply(BigDecimal.valueOf(10));
        BigDecimal expectedPremium = baseCost.multiply(new BigDecimal("2.0"))
